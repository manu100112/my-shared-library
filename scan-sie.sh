...
echo "private.db.layers=1,2,1200" >>conf/common.properties
...
#rename private database name
mv private/db/server/solutionsieapp.data private/db/server/solutionie_app.data
mv private/db/server/solutionsieapp.properties private/db/server/solutionie_app.properties
mv private/db/server/solutionsieapp.script private/db/server/solutionie_app.script
...
./scanAWSSuite.sh ${prefix}_scan.json
